...
function App() {
    ...
    const handleAddFiles = useCallback(
        () => handleOpenImages(() => isMac ? AppAPI.OpenImages() : AppAPI.OpenFolder(), isMac ? "open images" : "open folder"),
        [handleOpenImages, isMac]
    );

    const handleAddFilesOnly = useCallback(
        () => handleOpenImages(() => AppAPI.OpenFiles(), "open files"),
        [handleOpenImages]
    );

    const handleOpenFolderOnly = useCallback(
        () => handleOpenImages(() => AppAPI.OpenFolder(), "open folder"),
        [handleOpenImages]
    );
            ...
            <header className="top-bar" onDoubleClick={(e) => {
                ...
                <div className="top-bar-actions">
                    ...
                    <div className="btn-group">
                        <button className="btn btn-secondary" onClick={handleOpenFolderOnly} disabled={isSelecting}>
                            Open Folder
                        </button>
                        <div 
                            className="dropdown"
                        ...
                        >
                            ...
                            {openMenuVisible && (
                                <div className="dropdown-menu" role="menu">
                                    <button className="dropdown-item" role="menuitem" onClick={() => { setOpenMenuVisible(false); handleAddFilesOnly(); }}>Open Files</button>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="btn-group">
                            ...
                            {imageManager.importedImages.length > 1 && (
                                ...
                                >
                                    ...
                                    {exportMenuVisible && (
                                        <div className="dropdown-menu" role="menu">
                                            <button className="dropdown-item" role="menuitem" onClick={() => { setExportMenuVisible(false); downloadAllImages(); }}>Export All</button>
                                        </div>
                                    )}
                                </div>
                            )}
